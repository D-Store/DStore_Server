...
import gg.dstore.domain.repository.*;

import gg.dstore.enums.Leader;

import gg.dstore.service.comment.CommentService;
import gg.dstore.service.file.FileService;
import gg.dstore.service.follow.FollowService;
import gg.dstore.service.like.LikeService;
import gg.dstore.service.multipart.MultipartService;
import gg.dstore.service.tag.TagService;
import gg.dstore.service.user.UserService;
...
public class ProjectServiceImpl implements ProjectService {
	...
	public Long countProject(UserEntity user) {
		try {
//			List<ProjectUserConnectEntity> users = projectUserConnectRepository.findAllByUser(user);
			return projectRepository.countByUsersAndOnDelete(user.getId(), 0);
		} catch (Exception e) {
			throw e;
		}
	}
